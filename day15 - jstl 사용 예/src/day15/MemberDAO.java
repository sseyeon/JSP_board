...
//			pstmt.setString(2, "넣고싶은값");	물음표가 두개라면 
	...
	public int UpdateMember(MemberVO upMember) {
		...
		try {
			...
			pstmt.setString(1, upMember.getUserpw());
			pstmt.setString(2, upMember.getUsername());
			pstmt.setString(3, upMember.getAge());
			pstmt.setString(4, upMember.getGender());
			pstmt.setString(5, upMember.getUserid());
			result = pstmt.executeUpdate();
	...
	public ArrayList<MemberVO> getMemberList() {
		ArrayList <MemberVO> list = new ArrayList<MemberVO>();	// 비어있는 리스트 생성
